...
import com.myCAFE.food.controller.CartController;
import com.myCAFE.food.controller.FoodController;
import com.myCAFE.food.controller.LoginController;
import com.myCAFE.food.controller.RegistrationController;
...
public class ApiTests {
    ...
    public void postCheckUsernameApi() throws Exception {
        mvc.perform(MockMvcRequestBuilders
                .post("/checkUserName")
                .content("amank").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
